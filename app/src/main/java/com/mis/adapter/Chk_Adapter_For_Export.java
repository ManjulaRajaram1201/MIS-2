...
public class Chk_Adapter_For_Export extends ArrayAdapter<Chk_Model> {
	Context context;
	...
	public Chk_Adapter_For_Export(Context context, List<Chk_Model> pOList) {
