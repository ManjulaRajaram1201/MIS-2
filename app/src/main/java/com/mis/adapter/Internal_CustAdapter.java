...
public class Internal_CustAdapter extends BaseAdapter implements Filterable{
	Context context;
	...
	public Internal_CustAdapter(Context context, List<String> selected_ord,
			List<String> cust) {
	...
	private class ModelFilter extends Filter {
		...
		protected FilterResults performFiltering(CharSequence constraint) {
			...
			if (constraint == null || constraint.length() == 0) {
				...
				if (IntOrderList.order_Details.equals("ON")) {
		...
		protected void publishResults(CharSequence constraint,
			...
			if (results.count == 0)
				...
				Internal_CustAdapter.this.notifyDataSetChanged();
			}
		}
	}
