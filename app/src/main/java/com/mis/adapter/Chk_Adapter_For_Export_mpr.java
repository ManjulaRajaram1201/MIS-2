...
import com.mis.controller.MprExport;
...
public class Chk_Adapter_For_Export_mpr extends ArrayAdapter<Chk_Model> {
	Context context;
	...
	public Chk_Adapter_For_Export_mpr(Context context, List<Chk_Model> pOList) {
